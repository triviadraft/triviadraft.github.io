...
def generate_jsons():
    ...
    for category in ['Clint Eastwood', 'Coen Brothers', 'Comedies', 'Coming of Age', 'Coppolas', 'Cornetto Trio', 'Courtroom Dramas & Legal Thrillers', 'Crime', 'Cusacks', 'Dance', 'David Fincher', 'David Lynch', 'Denzel Washington', 'Disney', 'Douglases', 'Dramas', 'DreamWorks Animation', 'Dwayne Johnson', 'Eastwoods', 'Ed Harris', 'Eddie Murphy', 'Emily Blunt', 'Emmas', 'Family', 'Fantasy/Sci-Fi', 'Fast & Furious', 'Frances McDormand', 'Frank Capra', 'Gene Hackman', 'Guillermo del Toro', 'Gyllenhaals', 'Halle Berry', 'Harrison Ford', 'Hepburns', 'Horror', 'Horror/Thriller', 'Ice Cube', 'Jack Nicholson', 'Jackie Chan', 'James Stewart', 'Jamie Lee Curtis', 'Jennifer Aniston', 'Jennifer Connelly', 'Jennifer Lawrence', 'Jennifer Lopez', 'Jim Carrey', 'Jodie Foster', 'John Candy', 'John Carpenter', 'John Hughes', 'John Singleton', 'Julia Roberts', 'Keanu Reeves', 'Kevin Hart', 'Kevin Smith', 'Kurt Russell', 'Leonardo DiCaprio', 'M. Night Shyamalan', 'Margot Robbie', 'Marshalls', 'Martin Scorsese', 'Matt & Ben', 'Meg Ryan', 'Mel Brooks', 'Meryl Streep', 'Michael Keaton', 'Michelle Pfeiffer', 'Modern Classics', 'Morgan Freeman', 'Natalie Portman', 'Nicolas Cage', 'Nicole Kidman', 'Nora Ephron', 'Octavia Spencer', 'Paul Newman & Robert Redford', 'Queen Latifah', 'Quentin Tarantino & Robert Rodriguez', 'Ramis & Reitmans', 'Reese Witherspoon', 'Reginas', 'Richard Donner', 'Robert De Niro & Joe Pesci', 'Robert Downey Jr.', 'Robert Zemeckis', 'Robin Williams', 'Rom-Coms', 'Romance', 'Samuel L. Jackson', 'Scarlett Johansson', 'Scotts', 'Sean Connery', 'Sheens', 'Sigourney Weaver', 'Sly & Arnie', 'Spike Lee', 'Stanley Tucci', 'Steven Soderbergh', 'Steven Spielberg', 'Thriller', 'Tim Burton', 'Tom Cruise', 'Tom Hanks', 'Tyler Perry', 'Viola Davis', 'Wachowskis', 'Wayans Family', 'Whoopi Goldberg', 'Will Smith']:
        file_prefix = category.replace('/', '_')
        with open('python/csv/' + file_prefix + ' - Movies.csv', encoding='utf-8') as csvf:
            csvReader = csv.DictReader(csvf)
            for row in csvReader:
