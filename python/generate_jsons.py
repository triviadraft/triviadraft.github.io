...
def generate_jsons():
    ...
    for category in ['Clint Eastwood', 'Coen Brothers', 'Comedies', 'Coming of Age', 'Coppolas', 'Cornetto Trio', 'Courtroom Dramas & Legal Thrillers', 'Crime', 'Cusacks', 'Dance', 'David Fincher', 'David Lynch', 'Denzel Washington', 'Disney', 'Douglases', 'Dramas', 'DreamWorks Animation', 'Dwayne Johnson', 'Eastwoods', 'Ed Harris', 'Eddie Murphy', 'Emily Blunt', 'Emmas', 'Family', 'Fantasy/Sci-Fi', 'Fast & Furious', 'Frances McDormand', 'Frank Capra', 'Frat Pack', 'Gene Hackman', 'Guillermo del Toro', 'Gyllenhaals', 'Halle Berry', 'Happy Madison & Adam Sandler', 'Harrison Ford', 'Hepburns', 'Historical Epics & Dramas', 'Holiday', 'Horror', 'Horror/Thriller', 'Ice Cube', 'Jack Nicholson', 'Jackie Chan', 'James Bond', 'James Stewart', 'Jamie Lee Curtis', 'Jennifer Aniston', 'Jennifer Connelly', 'Jennifer Lawrence', 'Jennifer Lopez', 'Jim Carrey', 'Jodie Foster', 'John Candy', 'John Carpenter', 'John Hughes', 'John Singleton', 'Julia Roberts', 'Keanu Reeves', 'Kevin Hart', 'Kevin Smith', 'Kurt Russell', 'Leonardo DiCaprio', 'LGBTQ Cinema', 'Lucasfilm', 'M. Night Shyamalan', 'Margot Robbie', 'Marshalls', 'Martial Arts', 'Martin Scorsese', 'Matt & Ben', 'Meg Ryan', 'Mel Brooks', 'Meryl Streep', 'Michael Keaton', 'Michelle Pfeiffer', 'Modern Classics', 'Monster', 'Morgan Freeman', 'Musicals', 'Musicians in Film', 'Mystery', 'Natalie Portman', 'Nicolas Cage', 'Nicole Kidman', 'Nora Ephron', 'Octavia Spencer', 'Paul Newman & Robert Redford', 'Period Pieces & Costume Dramas', 'Pixar', 'Queen Latifah', 'Quentin Tarantino & Robert Rodriguez', 'Ramis & Reitmans', 'Rat Pack', 'Reese Witherspoon', 'Reginas', 'Remakes & Reboots', 'Richard Donner', 'Robert De Niro & Joe Pesci', 'Robert Downey Jr.', 'Robert Zemeckis', 'Robin Williams', 'Rocky', 'Rom-Coms', 'Romance', 'Samuel L. Jackson', 'Scarlett Johansson', 'Scotts', 'SCTV Alumni', 'Sean Connery', 'Sheens', 'Sigourney Weaver', 'Sly & Arnie', 'SNL & Lorne Michaels', 'Spike Lee', 'Spoof', 'Sports', 'Spy', 'Stanley Tucci', 'Stephen King', 'Steven Soderbergh', 'Steven Spielberg', 'Streaming', 'Thriller', 'Tim Burton', 'Tom Cruise', 'Tom Hanks', 'Tyler Perry', 'Viola Davis', 'Wachowskis', 'Wayans Family', 'Westerns', 'Whoopi Goldberg', 'Will Smith', 'Wrestlers in Film', 'Young Adult Adaptations']:
        file_prefix = category.replace('/', '_')
        with open('python/csv/' + file_prefix + ' - Movies.csv', encoding='utf-8') as csvf:
            csvReader = csv.DictReader(csvf)
            for row in csvReader:
